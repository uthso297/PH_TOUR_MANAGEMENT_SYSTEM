...
const startServer = async () => {
    try {
        await mongoose.connect('mongodb+srv://uthsoDB:UthsoMef3647@cluster0.g3mp55c.mongodb.net/tour-management-backend?retryWrites=true&w=majority&appName=Cluster0')
